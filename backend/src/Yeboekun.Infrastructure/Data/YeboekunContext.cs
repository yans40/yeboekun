...
namespace Yeboekun.Infrastructure.Data;

public class YeboekunContext : DbContext
{
    public YeboekunContext(DbContextOptions<YeboekunContext> options) : base(options)
    {
    }
