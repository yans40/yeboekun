...
La **vue éventail** (fan view) est l'ADN visuel de Yeboekun. Toute évolution UI doit la traiter comme l'écran-héros, pas comme une option parmi d'autres. Si tu proposes de la remplacer un jour, il te faudra une justification produit très solide.
