...
// Direction header
// =================================================================
function DirectionHeader({ letter, name, subtitle, reference, accent }) {
  return (
    <div style={{
  ...
  return (
    <Section tone="ivory" id="direction-a" style={{padding: '120px 96px'}}>
      <DirectionHeader
        ...
        reference="Gallimard, Folio Histoire, Bibliothèque nationale. La sobriété d'un colophon d'éditeur sérieux. Le pictogramme se fait reconnaître seulement pour qui en connaît la grammaire."
      />
  ...
  return (
    <Section tone="cream" id="direction-b" style={{padding: '120px 96px'}}>
      <DirectionHeader
        ...
        reference="Aesop, Apartamento, Are.na. Le geste est dans la lettre, pas à côté. La marque tient en un seul signe."
      />
  ...
  return (
    <Section tone="paper" id="direction-c" style={{padding: '120px 96px'}}>
      <DirectionHeader
        ...
        reference="Sceaux d'éditeurs anciens, marques d'imprimeurs du XVIᵉ. Logo de la NRF, blasons de bibliothèques. Une forme close, dense, à laquelle on ne peut rien ajouter."
      />
